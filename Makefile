...
linux:
	CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o embedded_resources ${LDFLAGS} .
osx:
	CGO_ENABLED=0 GOOS=darwin go build -a -installsuffix cgo -o embedded_resources ${LDFLAGS} .
